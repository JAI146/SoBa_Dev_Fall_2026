...
const ICONS: Record<SidebarNavIconName, (props: IconProps) => ReactNode> = {
  overview: LayoutDashboardIcon,
  families: HomeIcon,
  donors: UsersIcon,
  sponsorships: HeartHandshakeIcon,
  profileUpdates: ClipboardCheckIcon,
  chat: MessageSquareIcon,
  legal: ScaleIcon,
  settings: SettingsIcon,
  subAdmins: ShieldIcon,
  activityLogs: ActivityIcon,
  myFamilies: HomeIcon,
  messages: MessageSquareIcon,
  notices: BellIcon,
  tickets: MessageSquareIcon,
  transferRequests: TransferIcon,
  profile: UserIcon,
};
