export function buildPasswordResetEmailHtml(params: {
  ...
  return (
    ...
    '<h1 style="margin:0 0 12px;color:#064e3b;font-size:24px">Reset your password</h1>' +
    '<p style="color:#475569;line-height:1.6">Hi ' +
    escapeHtml(params.firstName) +
    ', use this one-time code to reset your PurposeMint password.</p>' +
    '<div style="margin:28px 0;padding:16px;text-align:center;border-radius:12px;' +
