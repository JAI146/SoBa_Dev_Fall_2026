...
export class User {
  ...
  @Column({ name: "delete_account_requested_at", type: "timestamptz", nullable: true })
  deleteAccountRequestedAt!: Date | null;

  @Column({ name: "policy_agreements", type: "jsonb", default: {} })
  policyAgreements!: Record<string, string>;

  @Column({ name: "email_otp_hash", type: "varchar", length: 255, nullable: true })
  emailOtpHash!: string | null;

  @Column({ name: "email_otp_expires_at", type: "timestamptz", nullable: true })
  emailOtpExpiresAt!: Date | null;

  @Column({ name: "password_reset_otp_hash", type: "varchar", length: 255, nullable: true })
  passwordResetOtpHash!: string | null;

  @Column({ name: "password_reset_otp_expires_at", type: "timestamptz", nullable: true })
